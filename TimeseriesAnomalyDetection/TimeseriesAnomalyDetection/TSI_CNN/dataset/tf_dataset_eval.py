...
def load_file(filename):
    ...
    print("loading new datafile: " + filename)
    X = np.array(pd.read_csv(
        "./TimeseriesAnomalyDetection/TSI_CNN/dataset/data/upload_data/" + filename))
...
def get_tf_dataset(bs=32, filename=""):
    """
