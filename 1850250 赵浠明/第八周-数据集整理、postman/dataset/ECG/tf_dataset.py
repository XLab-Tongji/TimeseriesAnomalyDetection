...
def init_val():
    ...
    normal = np.array(pd.read_csv(
        "/workspace/AnomalyDetection/TimeseriesAnomalyDetection/ECG/dataset/data/normal.csv"))
    abnormal = np.array(pd.read_csv(
        "/workspace/AnomalyDetection/TimeseriesAnomalyDetection/ECG/dataset/data/abnormal.csv"))
    # balance the dataset
